const errorsDictionary = {
    ...
    INVALID_MONGOID_FORMAT: { code: 400, message: 'El ID no contiene un formato válido' },
    ...
    ID_NOT_FOUND: { code: 400, message: 'No existe producto con ese ID' },
    ...
    NO_AUTH_TOKEN: { code: 401, message: 'Éste recurso requiere un token de autenticación'},
    ...
    INSUFFICIENT_STOCK: { code: 200, message: 'No hay stock suficiente' },
    NO_TICKET_GENERATED: { code: 200, message: 'No se ha generado ticket, no hay stock para ningún producto en éste momento' },
    USER_NOT_FOUND: { code: 400, message: 'Usuario no encontrado' },
    ERROR_PASSWORD: { code: 400, message: 'La contraseña nueva debe ser diferente a la actual' },
    NOT_EXIST: { code: 400, message: 'Valones inexistentes' },
    ERROR_ROLE: { code: 400, message: 'Error al cambiar el rol' },
    ROLE_OK: { code: 200, message: 'Rol cambiado exitosamente' }
}
